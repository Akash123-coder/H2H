      ...
      <div class="overflow-x-auto relative shadow-md sm:rounded-lg p-10">
        <div class="flex md:justify-between md:items-center pb-4  flex-wrap gap-3">
          <div className="relative">
            ...
            />
            <div className="text-lg font-semibold tracking-wide bg-indigo-400 h-fit p-2   text-gray-800">
             <span className='h-full bg-yellow-300 text-yellow-300 z-20' >|</span> Total Reimbursement: <span className='text-lg text-black '>3897$</span>
            </div>
          </div>
        </div>
        <AccodianData />
