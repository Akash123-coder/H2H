...
function Login() {
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
	...
	<div
		...
		<div>
			<h1 class="text-white font-bold text-4xl font-sans">Sign Up</h1>
			<p class="text-white mt-1">Lets get started with Heal2Health</p>
                    <div class="grid grid-flow-row md:grid-cols-3 gap-8 text-white mt-10 hover:text-gray-800 ">
          <div class="relative">
            <input
            ...
            <label
              class="block p-2 text-sm font-medium transition-colors border border-gray-100 rounded-lg shadow-sm cursor-pointer peer-checked:border-indigo-500 hover:bg-gray-50 peer-checked:ring-1 peer-checked:ring-indigo-500"
              for="standard_alt"
            >
              <span> Doctor </span>
