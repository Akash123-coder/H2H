        ...
        <div>
          ...
          <div class="grid grid-flow-row md:grid-cols-3 pb-10 gap-8 text-white mt-10 ">
            <div class="relative">
              ...
              <label
                class="block p-2 text-sm font-medium transition-colors border border-gray-100  hover:text-gray-800 rounded-lg shadow-sm cursor-pointer peer-checked:border-indigo-500 peer-checked:bg-white-500 hover:bg-gray-50 peer-checked:ring-1 peer-checked:ring-indigo-500"
                for="standard_alt"
              >
                <span> Doctor </span>
