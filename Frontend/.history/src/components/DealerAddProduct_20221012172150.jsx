...
<div id="drawer-form" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-transform left-0 top-0 -translate-x-full" tabindex="-1" aria-labelledby="drawer-form-label" aria-hidden="true"/>
   ...
   <form action="#" class="mb-6">
	...
	<div className="flex">
		<input type="text" name="price" id="price" placeholder="99 999,99" className="flex flex-1 text-right border sm:text-sm rounded-l-md focus:ring-inset dark:border-gray-300 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400" />
