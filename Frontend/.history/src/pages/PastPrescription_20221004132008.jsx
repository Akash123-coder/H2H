        ...
        <div class="flex justify-between items-center pb-4">
          ...
          <div className="relative">
            <div
              ...
              class="flex flex-nowrap align-center p-2 pl-10 w-80 text-sm text-gray-900 bg-gray-50 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            />
