  ...
  return (
    <div class="h-full md:h-screen md:flex py-10 ">
      ...
      <div class="relative flex w-full h-full overflow-hidden md:flex md:w-1/2  bg-gradient-to-tr md:rounded-l-lg from-blue-800 to-purple-700 i justify-around items-center ">
        ...
        <div class="absolute  bg-green-400  -bottom-32 -left-40 w-80 h-80 border-4 rounded-full border-opacity-30 border-t-8"></div>
        <div class="absolute  bg-green-400 -bottom-40 -left-20 w-80 h-80 border-4 rounded-full border-opacity-30 border-t-8"></div>
        <div class="absolute  bg-green-400 -top-40 -right-0 w-80 h-80 border-4 rounded-full border-opacity-30 border-t-8"></div>
        <div class="absolute  bg-green-400 -top-20 -right-20 w-80 h-80 border-4 rounded-full border-opacity-30 border-t-8"></div>
      </div>
    </div>
  );
}
