...
function Login() {
  ...
  <a href="#" aria-current="page" class="py-2 px-4 text-sm font-medium text-indigo-700 bg-white rounded-l-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-indigo-700 focus:text-indigo-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-indigo-500 dark:focus:text-white">
    Doctor
  </a>
