...
<label for="companies" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Select company</label>
<select id="companies" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  ...
  <option>Germany</option>
	...
	<div className="flex">
		...
		<span className="flex items-center px-3 pointer-events-none sm:text-sm text-white rounded-r-md bg-indigo-700">₹</span>
	</div>
</fieldset>
      </div>
