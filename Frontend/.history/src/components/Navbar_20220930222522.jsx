...
function Navbar() {
  ...
  return (
    <div>
      <nav className=" relative border-b-2 w-full  bg-white px-2 sm:px-4  py-2.5 rounded top-0  dark:bg-gray-900 ">
        <div className="container bg-white w-full flex flex-wrap justify-between max-h-full fixed top-0 items-center mx-auto">
