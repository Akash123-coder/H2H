        ...
        <div class="flex md:justify-between md:items-center pb-4  flex-wrap gap-3">
          <div className="relative">
            ...
            <div className="text-lg font-semibold tracking-wide bg-indigo-400 h-fit p-2   text-gray-900">
             <span className='h-full bg-yellow-300 text-yellow-300 z-20' >|</span> Total Reimbursement: <span className='text-lg font-sans font-bold text-black tracking-wide '>3897$</span>
            </div>
          </div>
        </div>
        <AccodianData />
