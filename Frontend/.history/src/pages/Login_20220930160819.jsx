...
function Login() {
  return (
    <div class="h-screen md:flex py-10 ">
      <div class="flex w-full md:w-1/2 justify-center py-10 items-center bg-white">
        <div>
      ...
      <div class="relative overflow-hidden grid grid-flow-row md:flex w-1/2 bg-gradient-to-tr rounded-l-lg from-blue-800 to-purple-700 i justify-around items-center hidden">
        <div>
