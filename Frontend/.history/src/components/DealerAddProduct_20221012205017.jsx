...
<!-- drawer component --> */}
      ...
      <form action="#" class="mb-6">
        ...
        <div className="mb-4">
          <input
            type="text"
            class="block mb-2 border-gray-300 w-full font-medium text-gray-900 dark:text-gray-400 text-sm rounded-lg"
        ...
        <div class="mb-6">
          <label
            for="title"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300  focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500"
          >
            Title
          </label>
          <input
        ...
        <div class="mb-4">
          <div class="relative">
            ...
            <button
              type="button"
              class="absolute inline-flex items-center px-3 py-1 text-sm font-medium text-white bg-indigo-700 rounded-lg right-2 bottom-2 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
            >
              Add
            </button>
          </div>
        ...
        <button
          type="submit"
          class="text-white justify-center flex items-center bg-indigo-700 hover:bg-indigo-800 w-full focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
        >
          {" "}
          Create product
        </button>
