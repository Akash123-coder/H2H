...
function Login() {
  return (
    <div class="h-full md:h-screen md:flex py-10 ">
      ...
      <div class="relative flex w-full overflow-hidden md:flex md:w-1/2  bg-gradient-to-tr rounded-l-lg from-blue-800 to-purple-700 i justify-around items-center ">
        <div>
