      ...
      <form className=" px-5 md:w-2/3 p-5 ">
        <div className=" pb-10  font-sans text-3xl font-medium text-gray-800">
          <p className="flex justify-start">
            <span className=" box-decoration-slice underline decoration-blue-500 text-blue-500">
              Heal
            </span>
            <span className="text-orange-400 underline decoration-blue-500">
              2
            </span>
            <span className="pr-2 box-decoration-slice underline decoration-blue-500 text-green-500">
              Health
            </span>
            <span className="pr-2  text-orange-400">
              Wellness
            </span>
          </p>
        </div>
