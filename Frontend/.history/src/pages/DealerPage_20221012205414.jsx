      ...
      <div className="p-5 w-full flex">
        ...
        {Clicked ? (
          ...
          <button
            ...
            class="text-white inline-block w-56 text-lg bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg  px-5 py-2.5  dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
            type="button"
          >
            Add Product
          </button>
